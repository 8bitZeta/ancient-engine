...
; - UnownAnimationPointers (see gfx/pokemon/anim_unown.asm)
; - UnownAnimationIdlePointers (see gfx/pokemon/idle_unown.asm)
; - UnownBitmasksPointers (see gfx/pokemon/bitmask_unown.asm)
; - UnownFramesPointers (see gfx/pokemon/frame_unown.asm)
	const_def 1
	const UNOWN_A            ;  1
	const UNOWN_B            ;  2
	const UNOWN_C            ;  3
